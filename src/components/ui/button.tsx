  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        outline: 'border border-border/50 bg-white/50 backdrop-blur-sm text-foreground shadow-sm hover:bg-white/80 hover:border-border dark:bg-white/10 dark:hover:bg-white/20',
        secondary: 'bg-secondary/80 text-secondary-foreground shadow-sm hover:bg-secondary/90 backdrop-blur-sm',
